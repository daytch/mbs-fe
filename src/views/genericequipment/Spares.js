...
function Table({ updateSpare, currencies, columns, data, updateMyData, skipPageReset }) {
  const {
    getTableProps,
    getTableBodyProps,
    headerGroups,
...
const Spares = ({ equipmentModelSpareParts, updateSpare, currencies, isNew }) => {
  ...
  const [data, setData] = useState(() => makeData(20, 'spares', equipmentModelSpareParts))
