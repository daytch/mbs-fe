...
const CostOutputBackup = ({
    ...
    const [title, setTitle] = useState('EquipmentCommissioningCostByCostCentre')
    ...
    const dtEquipmentDisposalByCostCentre = useSelector(state => state.CostOutput.dtEquipmentDisposalByCostCentre)
    const dtEquipmentDisposalValueSummary = useSelector(state => state.CostOutput.dtEquipmentDisposalValueSummary)
    const dtMaterialsServicesCostByCostCentre = useSelector(state => state.CostOutput.dtMaterialsServicesCostByCostCentre)
    const dtMaterialsCostByCostCentre = useSelector(state => state.CostOutput.dtMaterialsCostByCostCentre)
    const dtServicesCostByCostCentre = useSelector(state => state.CostOutput.dtServicesCostByCostCentre)
    const dtMaterialsServicesCostConsumedByEquipment = useSelector(state => state.CostOutput.dtMaterialsServicesCostConsumedByEquipment)
    const dtMaterialsServicesCostNotConsumedByEquipment = useSelector(state => state.CostOutput.dtMaterialsServicesCostNotConsumedByEquipment)
    const dtMaterialsServicesCostSummary = useSelector(state => state.CostOutput.dtMaterialsServicesCostSummary)
    const dtEmployeeExcludingReliefCostByCostCentre = useSelector(state => state.CostOutput.dtEmployeeExcludingReliefCostByCostCentre)
    const dtEmployeeExcludingReliefCostSummary = useSelector(state => state.CostOutput.dtEmployeeExcludingReliefCostSummary)
    const dtEmployeeRequiredForReliefCostByCostCentre = useSelector(state => state.CostOutput.dtEmployeeRequiredForReliefCostByCostCentre)
    const dtEmployeeRequiredForReliefCostSummary = useSelector(state => state.CostOutput.dtEmployeeRequiredForReliefCostSummary)
    const dtEmployeeTotalCostByCostCentre = useSelector(state => state.CostOutput.dtEmployeeTotalCostByCostCentre)
    const dtEmployeeTotalCostSummary = useSelector(state => state.CostOutput.dtEmployeeTotalCostSummary)
    const dtInfrastructureCostByCostCentre = useSelector(state => state.CostOutput.dtInfrastructureCostByCostCentre)
    const dtInfrastructureCostSummary = useSelector(state => state.CostOutput.dtInfrastructureCostSummary)
