...
const EquipmentRequiredByCostCentre = ({excelData, project, projectRepresentation}) => {
  ...
  const ws = XLSX.utils.aoa_to_sheet([
    ...
    [''],
    ['Equipment Required By Cost Centre'],
    ["Cost Centre","Period"],
    ['Code', 'Description'],
  ])
  ...
  FileSaver.saveAs(data, "EquipmentRequiredByCostCentre", +fileExtension)
}
