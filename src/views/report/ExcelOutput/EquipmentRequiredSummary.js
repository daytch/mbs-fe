...
const EquipmentRequiredSummary = ({excelData, project, projectRepresentation}) => {
  ...
  FileSaver.saveAs(data, "EquipmentRequiredSummary", +fileExtension)
}
