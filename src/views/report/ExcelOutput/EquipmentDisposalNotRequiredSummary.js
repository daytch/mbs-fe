...
const EquipmentDisposalNotRequiredSummary = ({excelData, project, projectRepresentation}) => {
  ...
  const ws = XLSX.utils.aoa_to_sheet([
    ...
    [''],
    ['Equipment Disposal Expired Summary'],
    [...headerCol, ...listPeriods.map((item) => item.periodName), 'Max'],
  ])
  XLSX.utils.sheet_add_json(ws, excelData, { origin: 'A6' , skipHeader: true})
  ...
  FileSaver.saveAs(data, "EquipmentDisposalNotRequiredSummary", +fileExtension)
}
