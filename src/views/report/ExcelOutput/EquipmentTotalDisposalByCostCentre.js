...
const EquipmentTotalDisposalByCostCentre = ({excelData, project, projectRepresentation}) => {
  ...
  FileSaver.saveAs(data, "EquipmentTotalDisposalByCostCentre", +fileExtension)
}
