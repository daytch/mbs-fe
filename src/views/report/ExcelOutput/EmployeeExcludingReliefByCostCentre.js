...
const EmployeeExcludingReliefByCostCentre = ({excelData, project, projectRepresentation}) => {
  ...
  FileSaver.saveAs(data, "EmployeeExcludingReliefByCostCentre", +fileExtension)
}
