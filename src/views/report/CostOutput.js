...
const CostOutput = ({
  ...
  useEffect(() => {
    ...
    dispatch(getEqpDispossalValueByCostCentre(projRep.projectRepresentationId))
    dispatch(getEqpDispossalValueSummary(projRep.projectRepresentationId))
  ...
  const renderCostOutputData = {
    ...
    EquipmentDispossalValueByCostCentre: () =>
      dtEquipmentReplacementByCostCentre ? (
    ...
    EquipmentDispossalValueSummary: () =>
      dtEquipmentReplacementSummary?.length > 0 ? (
