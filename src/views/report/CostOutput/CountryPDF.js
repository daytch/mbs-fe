...
const CountryPDF = (props) => {
  const { countries, project, projectRepresentation, showHeader, showFooter } = props
  ...
  return (
    <Document>
      <Page style={styles.body}>
        ...
        {showHeader && Header('Countries And Currencies')}
